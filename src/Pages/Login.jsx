...
export default function Login({ setToken }) {
  ...
  return (
    <>
      ...
      {/* ff */}
      <div className="max-w-md mx-auto mt-6 mb-6 p-6 bggreen shadow-md rounded-xl">
        ...
        <form onSubmit={login}>
          <div className="mb-4 ">
            ...
            <input
              type="email"
              className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-700 transition duration-300 bg-white"
              value={email}
